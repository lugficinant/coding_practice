...
app.post("/submit", (req, res) => {
  console.log("give you a band name😎😎");
  ...
  const aadj = adj[Math.floor(Math.random() * adj.length)];
  const nnoun = noun[Math.floor(Math.random() * noun.length)];
  // res.render("index.ejs", { yourAdj: aadj, yourNoun: nnoun });
  res.render("index.ejs", { aadj, nnoun });
});
